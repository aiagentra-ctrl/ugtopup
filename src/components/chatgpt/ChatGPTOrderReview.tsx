...
import { ChatGPTFormData } from "./ChatGPTUserInputForm";
import { useAuth } from "@/contexts/AuthContext";
import { AlertTriangle } from "lucide-react";

interface ChatGPTOrderReviewProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  selectedPackage: ChatGPTPackage | null;
  formData: ChatGPTFormData | null;
  orderId: string;
}

export const ChatGPTOrderReview = ({
  isOpen,
  onClose,
  onConfirm,
  selectedPackage,
      ...
      <AlertDialogContent className="max-w-md bg-card/95 backdrop-blur-xl border-primary/30 shadow-[0_0_50px_rgba(255,0,0,0.3)]">
        ...
        <div className="space-y-4 py-4">
          <div className="space-y-3">
            ...
            <div className="pb-3 border-b border-border/20">
              <p className="text-sm text-muted-foreground mb-1">Email Password</p>
