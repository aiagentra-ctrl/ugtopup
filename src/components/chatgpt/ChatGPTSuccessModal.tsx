...
interface ChatGPTSuccessModalProps {
  isOpen: boolean;
  onClose: () => void;
  orderId: string;
...
export const ChatGPTSuccessModal = ({ isOpen, onClose, orderId, onSubscribeAgain }: ChatGPTSuccessModalProps) => {
      ...
      <DialogContent className="max-w-md glass-card border-border/50">
        <DialogHeader className="text-center">
          ...
          <DialogDescription className="text-base pt-2">
            Your ChatGPT Plus subscription has been confirmed and is being processed.
          </DialogDescription>
        </DialogHeader>
