...
interface RobloxSuccessModalProps {
  isOpen: boolean;
  onClose: () => void;
  orderId: string;
  onTopUpAgain: () => void;
...
export const RobloxSuccessModal = ({ isOpen, onClose, orderId, onTopUpAgain }: RobloxSuccessModalProps) => {
      ...
      <DialogContent className="bg-slate-900 border-slate-800 text-slate-100">
        <DialogHeader>
          ...
          <DialogDescription className="text-center text-slate-400">
            Your Roblox top-up order has been received
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          <p className="text-sm text-slate-400 text-center">
            ...
            Robux will be credited to your account within 5-10 minutes after confirmation.
          </p>
        </div>
