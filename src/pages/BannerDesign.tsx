...
import { bannerDesignPackage } from "@/data/designPackages";
  ...
  const handleConfirmOrder = async (couponCode?: string, finalPrice?: number) => {
    ...
    try {
      await createOrder({
        ...
        product_name: "Banner Design",
        package_name: bannerDesignPackage.name,
        quantity: 1,
        price: finalPrice ?? bannerDesignPackage.price,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 pb-24">
      <DesignProductHeader 
        ...
        subtitle="Web & Ad Banners"
        icon={bannerDesignPackage.icon}
      />
      <GamePageDescription slug="banner-design" />
      ...
      <div className="container mx-auto px-4 py-6 space-y-6">
        ...
        <DesignPackageDisplay package={bannerDesignPackage} />
      </div>
          ...
          >
            ...
            <span className="relative z-10">
              {!isFormValid
                ...
                : `Order Now - ₹${bannerDesignPackage.price}`}
            </span>
          </Button>
        </div>
      </div>
